...
export default function QuisProject() {
  ...
  return (
    <div className="container">
      <h1>Quis Project Time Tracker</h1>
      <p>Total Tasks: <strong>{tasks.length}</strong></p>
      <p>Average Task Duration: <strong>{formatTime(averageDuration)}</strong></p>
